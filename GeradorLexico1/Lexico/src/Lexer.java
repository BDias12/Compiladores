...
public class Lexer {
    ...
    boolean TokenScanf(String Lexema){
    ...
    void ClassificaLexema(String Lexema, int linha){
        ...
        void GerarTabelaDeSimbolos(){
            ...
            objTabelaDeSimbolos.adicionarSimbolo(Token.ABRE_PARENTESES, "ABRE_PARENTESES");
            objTabelaDeSimbolos.adicionarSimbolo(Token.FECHA_PARENTESES, "FECHA_PARENTESES");
            objTabelaDeSimbolos.adicionarSimbolo(Token.PONTO_VIRGULA, "PONTO_VIRGULA");
